 ...
 */
final class Version20200317160555 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE panier CHANGE product_id produit_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE panier CHANGE produit_id product_id INT NOT NULL');
